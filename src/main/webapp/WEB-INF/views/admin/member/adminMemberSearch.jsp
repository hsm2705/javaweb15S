...
<body>
<div class="container">
	<div class="text-center"><b>${searchTitle}&nbsp;:&nbsp;<font color="#8b0000">${pageVO.searchString}</font></b>(을)를 검색한 결과&nbsp;<font color="cd5c5c"><b>${pageVO.totRecCnt}</b></font>건이 검색되었습니다:)</div>
	  <div id="content">
	    <br>
