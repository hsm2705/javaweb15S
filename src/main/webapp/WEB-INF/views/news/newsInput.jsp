...
<body>
<jsp:include page="/WEB-INF/views/include/nav.jsp" /><br/><br/>
<jsp:include page="/WEB-INF/views/include/slide2.jsp" />
<p><br/></p>
<div class="container">
  <h2 class="text-center">뉴스작성</h2>
    ...
    <table class="table table-bordered">
      ...
      <tr>
        <td colspan="2" class="text-center">
          ...
          <input type="button" value="돌아가기" onclick="location.href='${ctp}/news/newsList';" class="btn btn-secondary"/>
        </td>
      </tr>
    </table>
